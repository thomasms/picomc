...
class Particle:
    ...
    def __repr__(self):
        return (f"Particle(pos={self.position}, dir={self.direction}, "
...
class Event:
    ...
    def __init__(self, particle: Particle, interaction_type: str,
                 position: np.ndarray, material: Optional[str] = None):
        """
        Initialize an event
    ...
    def __repr__(self):
        return (f"Event({self.interaction_type} at {self.position}, "
